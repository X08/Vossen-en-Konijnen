...
public class SimulatorView extends JFrame
{
    ...
    /**
     * Maak main frame aan en al zijn componenten
     * Main frame is de onderste laag, daarna komt tweede laag view panel (rechterkant) en toolbar panel (linkerkant).
     * Aan de toolbar panel worden knoppen toegevoegd en aan de view panel worden meerdere views toegevoegd(piecharts etc.)
     */
...
//        
        ...
        mainFrame.add(toolbar, BorderLayout.WEST);			//	toolbar toevoegen aan main frame
        
        
        //	maak een balk met versie nummer onderaan de frame en voeg toe aan de main frame
...
//        menu.add(item);
        ...
        item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, SHORTCUT_MASK));	//	hotkey toekennen aan dit item
        item.addActionListener(new ActionListener() 
        {
        	public void actionPerformed(ActionEvent e)
        	{ 
    ...
    /**
     * maak een pop up settings window, wordt opgeroepen wanneer menu item settings wordt gebruikt.
     * Settings wordt gebruikt om gegevens van een actoren te kunnen wijzigen
     */
    private void makeSettings()
    {
    	...
    	//	maak settings frame's main tab aan, size, layout en border van settings panel
        ...
        JTextField animationSpeed = new JTextField();
        ...
        settingsFrame.setSize(new Dimension(640, 480));
