...
public class FieldStats {
	...
	public String getPopulationDetails(Field field) {
		...
		for (Class key : counters.keySet()) {
			...
			buffer.append(info.getName().substring(6, stringLength)); // show
																		// info
			buffer.append(": ");
			...
			if (info.getName().equals("model.Rabbit")) {
				...
				// System.out.println(rabbitCount); rabbitCount wordt geupdate,
				// Hunter neemt niet over.
			}
	...
	/**
	 * Retourneert de HashMap counter die de populatie per soort bijhoudt met
	 * class
	 * 
